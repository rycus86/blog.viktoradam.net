...
Speaking of themes, I decided to keep the previous [Casper](https://github.com/TryGhost/Casper) theme from Ghost, I just hade to adapt it to Hugo. The existing port was a very good starting point, so I mostly just had to bring the ~~hacks~~ changes over that I've done on the original one. All in all, the whole theme setup took a couple of hours only, and it now lives [in the same repo](https://github.com/rycus86/blog.viktoradam.net/tree/master/themes/custom) as the posts.
...
If you're getting started with Hugo or Netlify and need help, or perhaps with excercising Ghost's API endpoints, find me with your questions &ndash; happy to help!
